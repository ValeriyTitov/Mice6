...
uses
  Vcl.Forms,
  MiceMain in 'MiceMain.pas' {MiceMainForm},
  ...
  Plugin.Builder.Ribbon in '..\Plugin\Plugin.Builder.Ribbon.pas',
  Plugin.List in '..\Plugin\Plugin.List.pas',
  Plugin.Container in '..\Plugin\Plugin.Container.pas',
  Plugin.CommandBuilder.Ribbon in '..\Plugin\Plugin.CommandBuilder.Ribbon.pas',
  ...
  Mice.ReportService in 'Mice.ReportService.pas',
  CustomControl.MiceValuePicker.SelectGridDlg in '..\CustomControls\Controls\CustomControl.MiceValuePicker.SelectGridDlg.pas' {VPickSelectGridDialog},
  ...
  Thread.ProgressForm in '..\Common\Thread.ProgressForm.pas' {ThreadProgressForm},
  CustomControl.MiceGrid.MenuBuilder in '..\CustomControls\Grids\CustomControl.MiceGrid.MenuBuilder.pas',
  Common.FormatSettings in '..\Common\Common.FormatSettings.pas';
...
begin
  ...
  if TStartupLoginDialog.Execute then
    Application.CreateForm(TMiceMainForm, MiceMainForm);
